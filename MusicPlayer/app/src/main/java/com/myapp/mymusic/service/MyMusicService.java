package com.myapp.mymusic.service;
...
public class MyMusicService extends Service {
    ...
    public class MyMusicBinder extends Binder {
        ...
        public MusicBean getCurrentMusic() throws NullPointerException{
            return currentMusic;
        }
        ...
        public void initMediaPlayer(MusicBean music){
            try{
                this.currentMusic = music;
                myMediaPlayer.reset(); // 重置音乐状态
                myMediaPlayer.setDataSource(music.getPath()); // 设置音乐源
        ...
        // 设置单曲循环
        public boolean setRepeating(boolean b){
            if (b){
